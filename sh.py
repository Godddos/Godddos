...
╔═══════════════════════════════════════════════════════════════╗
      _            _        _      _             
     | |          | |      (_)    | |            
   __| |_   _  ___| |_ _ __ _  ___| | _____ _ __ 
  / _` | | | |/ __| __| '__| |/ __| |/ / _ \ '__|
 | (_| | |_| | (__| |_| |  | | (__|   <  __/ |   
  \__,_|\__,_|\___|\__|_|  |_|\___|_|\_\___|_|   
  ╚═══════════════════════════════════════════════════════════════╝                                                   
╔═══════════════════════════════════════════════════════════════╗
 Tool Share Đa Luồng Của:  Đức BaKar
     Facebook:Dương Minh Đức
        Link: www.facebook.com/trumfbmduc
             Zalo:0868231853
               \033[1;95m  
╚═══════════════════════════════════════════════════════════════╝
"""
...
a = 0
stt=0
print('\033[1;33m Thêm Token Vào File "\033[1;36m (token.txt) \033[1;33m". Mỗi Dòng 1 Token !!!')
while(True):
  input('\033[1;33m Thêm Xong Thì Nhấn Enter Để Đức Lo ')
...
def share(i):
    ...
    if  'id' in retu:
        print('\033[1;32m',retu)
    else:
       print('\033[1;31m Token Die Hoặc Block Share Cmnr')
while (True):
